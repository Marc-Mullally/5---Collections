 ...
 */
var walking : [String] = ["Walk 3 miles a day", "Walk 999 miles a day"]
var running : [String] = ["Run 3 miles a day", "Run 9999 miles a day"]
...
if (commit.isEmpty) {
    ...
    print("The challenge you have chosen is \(commit[0])")
} else {
